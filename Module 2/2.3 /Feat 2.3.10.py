...
Необходимо написать программу для представления и управления расписанием телевизионного вещания. Для этого нужно
объявить класс TVProgram, объекты которого создаются командой:
...
class TVProgram:  # объекты которого создаются командой:
...
class Telecast:  # объекты которого создаются командой:
