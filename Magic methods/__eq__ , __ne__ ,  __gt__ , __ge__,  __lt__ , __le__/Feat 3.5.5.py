...
st = StringText(lst_words)  - где lst_words - список из слов одной строчки стихотворения.
...
lst_text = [StringText([word.strip("–?!,.;") for word in row.split()]) for row in stich]
lst_text_sorted = sorted(lst_text, reverse=True)
lst_text_sorted = [' '.join(lst.lst_words) for lst in lst_text_sorted]
