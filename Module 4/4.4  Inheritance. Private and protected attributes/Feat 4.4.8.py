...
speed - максимальная скорость (любое положительное число); top - максимальная высота полета (любое положительное число).
...
class Aircraft:
    ...
    def __setattr__(self, key, value):
        if key == '_model' and type(value) is not str:
            raise TypeError('неверный тип аргумента')
        if key in ('_mass', '_speed', '_top') and type(value) not in (int, float):
            raise TypeError('неверный тип аргумента')
...
class PassengerAircraft(Aircraft):
    ...
    def __setattr__(self, key, value):
        ...
        if key == '_chairs' and type(value) is not int:
            raise TypeError('неверный тип аргумента')
        if key == '_chairs' and value < 0:
            raise TypeError('неверный тип аргумента')
        return super().__setattr__(key, value)
...
class WarPlane(Aircraft):
    ...
    def __setattr__(self, key, value):
        super().__setattr__(key, value)
        if key == '_weapons' and type(value) is not dict:
            raise TypeError('неверный тип аргумента')
        return super().__setattr__(key, value)
